<?php $__env->startSection('title', 'Parámetros del Sistema - SIPAT'); ?>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        ...
        <a href="<?php echo e(route('parametros.exportar')); ?>" class="btn btn-info btn-sm">
            <i class="fas fa-download"></i> Exportar
        </a>
        <a href="<?php echo e(route('parametros.plantilla')); ?>" class="btn btn-warning btn-sm">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($metricas['modificables']); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($metricas['no_modificables']); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($categorias->count()); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select name="modificable" class="form-select">
                        ...
                        <option value="1" <?php echo e(request('modificable') === '1' ? 'selected' : ''); ?>>Sí</option>
                        <option value="0" <?php echo e(request('modificable') === '0' ? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $parametros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parametro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="parametro-<?php echo e($parametro->id); ?>">
                                <td>
                                    <span class="badge bg-secondary"><?php echo e($parametro->categoria); ?></span>
                                </td>
                                <td>
                                    <code><?php echo e($parametro->clave); ?></code>
                                </td>
                                <td>
                                    <strong><?php echo e($parametro->nombre); ?></strong>
                                    <?php if($parametro->descripcion): ?>
                                        <br>
                                        <small class="text-muted"><?php echo e(Str::limit($parametro->descripcion, 100)); ?></small>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <span class="badge bg-info"><?php echo e($parametro->tipo); ?></span>
                                </td>
                                <td>
                                    <span class="valor-actual" id="valor-<?php echo e($parametro->id); ?>">
                                        <?php if($parametro->tipo === 'BOOLEAN'): ?>
                                            <span class="badge bg-<?php echo e($parametro->valor === 'true' ? 'success' : 'danger'); ?>">
                                                <?php echo e($parametro->valor === 'true' ? 'Verdadero' : 'Falso'); ?>
                                ...
                                <td>
                                    <span class="text-muted">
                                        <?php if($parametro->tipo === 'BOOLEAN'): ?>
                                            <?php echo e($parametro->valor_por_defecto === 'true' ? 'Verdadero' : 'Falso'); ?>

                                        <?php else: ?>
                                            <?php echo e($parametro->valor_por_defecto); ?>

                                        <?php endif; ?>
                                    </span>
                                </td>
                                <td>
                                    <span class="badge bg-<?php echo e($parametro->modificable ? 'success' : 'secondary'); ?>">
                                        <?php echo e($parametro->modificable ? 'Sí' : 'No'); ?>
                                    ...
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <?php if($parametro->modificable): ?>
                                            ...
                                            <button type="button"
                                                    ...
                                                    onclick="restaurarDefecto(<?php echo e($parametro->id); ?>)"
                                                    title="Restaurar por defecto">
                                                <i class="fas fa-undo"></i>
                                            </button>
                                            <button type="button"
                                                    class="btn btn-danger"
                                                    onclick="eliminarParametro(<?php echo e($parametro->id); ?>)"
                                                    title="Eliminar">
...
<div class="modal fade" id="modalImportar" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('parametros.importar')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
function validarConfiguracion() {
    fetch('<?php echo e(route("parametros.validar")); ?>')
...
function mostrarEstadisticas() {
    const metricas = <?php echo json_encode($metricas, 15, 512) ?>;
...
Swal.fire({
    ...
    html: '<?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <li><?php echo e($error); ?></li> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>'
});
</script>
<?php endif; ?>
