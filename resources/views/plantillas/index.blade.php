...
@section('title', 'Plantillas - SIPAT')
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $metricas['activas'] }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $metricas['turnos_total'] }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h6 mb-0 font-weight-bold text-gray-800">{{ $metricas['ultima_generacion'] }}</div>
                    </div>
                    <div class="col-auto">
                    ...
                    <tbody>
                        @foreach($plantillas as $plantilla)
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-info">{{ $plantilla->total_turnos ?? $plantilla->turnos->count() }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="{{ route('plantillas.show', $plantilla) }}"
                                           class="btn btn-info" title="Ver detalles">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('plantillas.pdf', $plantilla->id) }}"
                                           class="btn btn-danger" title="Descargar PDF">
                                            <i class="fas fa-file-pdf"></i>
                                        </a>
                                        <a href="{{ route('plantillas.excel', $plantilla->id) }}"
